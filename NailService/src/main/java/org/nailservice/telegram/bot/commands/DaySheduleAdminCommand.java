...
public class DaySheduleAdminCommand extends Command {

    private final SheduleService sheduleService;
    private TelegramSheduleFormatter sheduleFormatter;

    public DaySheduleAdminCommand(String identifier, String description, SheduleService sheduleService,
    ...
    public void execute(AbsSender absSender, User user, Chat chat, String[] arguments) {
        ...
        sendAnswer(absSender, chat.getId(), this.getCommandIdentifier(), userName,
                sheduleFormatter.createSheduleTextForAdmin(shedule));
    }
}
